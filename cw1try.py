...
def get_geolocation():
    ...
    api_key = '1e87e280a6179e'  # Use the provided API key
...
def show_main_application():
    ...
    tk.Button(root, text="Scan IP", command=start_ip_scan, font=("Courier", 12), fg='black', bg='green').pack(pady=10)
    tk.Button(root, text="Get Location", command=start_geolocation_fetch, font=("Courier", 12), fg='black', bg='green').pack(pady=10)
    tk.Button(root, text="Toggle Dark/Light Mode", command=toggle_mode, font=("Courier", 12), fg='black', bg='green').pack(pady=10)
...
splash.iconbitmap(r'C:\Users\meoja\Downloads\meme dog.ico')  # Set your icon path

# Load splash image using tkinter.PhotoImage
splash_image_path = r"C:\Users\meoja\Downloads\hacker.png"  # Specify the path to your splash image
splash_image = tk.PhotoImage(file=splash_image_path)

splash_label = tk.Label(splash, image=splash_image, bg='black')
splash_label.pack()
